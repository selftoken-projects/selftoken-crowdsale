...
contract StandardToken is ERC20, Pausable {
     ...
     * @dev Constructor
     */ 
    constructor(string _symbol, string _name, uint256 _totalSupply) public Ownable() {
        symbol = _symbol;
        name = _name;
        decimals = 18;
     ...
     */
    function mintToken(address _target, uint256 _mintedAmount) public onlyOwner whenNotPaused {
